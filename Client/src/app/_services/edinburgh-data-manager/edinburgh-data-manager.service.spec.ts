...
describe('EdinburghDataManagerService', () => {
  let service: EdinburghDataManagerService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.get(EdinburghDataManagerService);
  ...
  it('should load data for the districts', () => {
    ...
    setInterval(() => {
      const req = httpMock.expectOne(r => r.method === 'GET' && r.url === '/api/all_scotland_ward_data');
      req.flush(dummyData);
  ...
  it('should fetch common words for each district', () => {
    ...
    setInterval(() => {
      ...
      const wordReq = httpMock.expectOne(r => r.method === 'GET' && r.url === '/api/common_words');
